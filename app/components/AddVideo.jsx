    ...
    return (
      <div className="addVideo">
        <form onSubmit={this.sendData}>
          ...
          <input placeholder="Ronaldoooooooooooooo" className="inputBorder" type="text" ref="name"/>
          <label>Enter link:</label>
          <input  placeholder="https://www.youtube.com/watch?v=9BsSPoVTRsQ" className="inputBorder" type="url" ref="url"/>
          <br></br>
